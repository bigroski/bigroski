...
function convert_to_unicode_short()
{
...
var array_one_length = array_one.length ;
    ...
    var modified_substring = document.getElementById("legacy_text_short").value  ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    var text_size = document.getElementById("legacy_text_short").value.length ;
...
//**********************************************
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      ...
      while (document.getElementById("legacy_text_short").value.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }
      
//   alert(" sthiti 1 = "+sthiti1); alert(" sthit 2 = "+sthiti2) 

     var modified_substring = document.getElementById("legacy_text_short").value.substring ( sthiti1, sthiti2 )  ;
...
//  processed_text = processed_text.replace( /mangal/g , "SUCHI-DEV-708 " ) ;   
    ...
    document.getElementById("unicode_text_short").value = processed_text  ;
...
modified_substring = modified_substring.replace( /Æ/g , "&Prime;" )   ;  
modified_substring = modified_substring.replace( /±/g , "+" )   ;  
modified_substring = modified_substring.replace( /-/g , "(" )   ;  
modified_substring = modified_substring.replace( /</g , "?" )   ;  
...
//date picker
$(function() {
       // $( "#datepicker" ).datepicker({ minDate: "-1M", maxDate: "0D" });
    });

</script>
<table id="dataGrid">
    <tr>
        <td>Type In Preeti</td>
        <td><textarea class="input" id="legacy_text_short" rows="7" cols="60" name="TextToConvert"></textarea></td>
    </tr>
    <tr>
        <td></td>
        <td><input type="button" name="converter" class="new_input" value="Click to convert above text in Preeti to Unicode" onclick="convert_to_unicode_short();" title="माथीको बाकसमा प्रीति फन्ट राखिसकेपछि यहाँ क्लिक गर्नुहोस्" id="converter" accesskey="c"></td>
    </tr>
    <tr>
        <td></td>
        <td><textarea class="input" id="unicode_text_short" rows="13" cols="60" name="shortdesc"></textarea></td>
    </tr>
</table>